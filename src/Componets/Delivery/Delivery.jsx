...
import { restorents } from '../../data/restorents';
...
const restorentsList = restorents;
...
export const Delivery = () => {
    return (
        <div className ="max-width">
            ...
            <DeliveryCollection />
            <Topbrands />
            <Exploresection list ={restorentsList} collectionName="Delivery Restorents In Banglore"/>
        </div>
    )
}
